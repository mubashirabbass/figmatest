...
export function TakeAwayPage({ onBack, onCompleteOrder, orderCounter, onIncrementCounter, staffName, products }: TakeAwayPageProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-gray-900">Take Away Orders</h1>
                <p className="text-sm text-gray-500">Select items for quick checkout</p>
              </div>
            </div>
